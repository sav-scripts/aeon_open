...
(lib.Tween2 = function() {
	...
	// Layer 1
	this.instance = new lib.product_bg();
	this.instance.setTransform(-485,-374);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-485,-374,970,748);
...
(lib.Symbol5 = function() {
	...
	// Layer 1
	this.instance = new lib._360_bg();
	this.instance.setTransform(-351,-432.5);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-351,-432.5,702,865);
...
(lib.PrizeKeyRing = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.gift_pro03();
	this.instance.setTransform(-126,-149);
...
(lib.PrizeHelm = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.gift_pro02();
	this.instance.setTransform(-160.5,-193.5);
...
(lib.PrizeCoat = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.gift_pro01();
	this.instance.setTransform(-205,-231);
...
(lib.WatchClip = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{StageIn:17,StageInComplete:39,ToDetail:58,ToDetailComplete:74});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(127));

	// DollLeft
	this.instance = new lib.GameDollLeft();
	this.instance.setTransform(-397.1,299,1,1,0,0,0,0,-175);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(17).to({alpha:0},0).to({alpha:1},22).wait(88));

	// DollRight
	this.instance_1 = new lib.GameDollRight();
	this.instance_1.setTransform(409,308.1,1,1,0,0,0,0,-170);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(17).to({alpha:0},0).to({alpha:1},22).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnBack).wait(59).to({_off:false},0).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.detailClip).wait(59).to({_off:false},0).to({alpha:1},15).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.progressClip).wait(59).to({_off:false},0).to({alpha:1},15).wait(53));

	// L_Label
	this.instance_2 = new lib.L_Label();
	this.instance_2.setTransform(-82.6,247.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(17).to({alpha:0},0).to({alpha:1},22).wait(19).to({alpha:0},15).to({_off:true},1).wait(53));

	// R_Label
	this.instance_3 = new lib.R_Label();
	this.instance_3.setTransform(89,245.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(17).to({alpha:0},0).to({alpha:1},22).wait(19).to({alpha:0},15).to({_off:true},1).wait(53));

	// L_Bike
	this.leftBike = new lib.WatchLeftBike();
	new cjs.ButtonHelper(this.leftBike, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.leftBike).wait(17).to({alpha:0},0).to({alpha:1},22).wait(19).to({alpha:0},15).to({_off:true},1).wait(53));

	// R_Bike
	this.rightBike = new lib.WatchRightBike();
	new cjs.ButtonHelper(this.rightBike, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.rightBike).wait(17).to({alpha:0},0).to({alpha:1},22).wait(19).to({alpha:0},15).to({_off:true},1).wait(53));

	// Basement
	this.instance_4 = new lib.Symbol5();

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17).to({alpha:0},0).to({alpha:1},22).wait(88));
...
(lib.PrizeClip = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"StageIn":16,"StageInComplete":36});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// DollRight
	this.instance_1 = new lib.GameDollRight();
	this.instance_1.setTransform(609,308.1,1,1,0,0,0,0,-170);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// Helm
	this.instance_2 = new lib.PrizeHelm();
	this.instance_2.setTransform(362.1,203.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// Title
	this.instance_3 = new lib.PrizeTitle();
	this.instance_3.setTransform(-200.6,-300.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// KeyRing
	this.instance_4 = new lib.PrizeKeyRing();
	this.instance_4.setTransform(-192.6,149);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// Coat
	this.instance_5 = new lib.PrizeCoat();
	this.instance_5.setTransform(122.4,-112);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));

	// OpenLogo
	this.instance_6 = new lib.PrizeOpenLogo();
	this.instance_6.setTransform(0,464);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(16).to({alpha:0},0).to({alpha:1},20).wait(52));
...
(lib.FeatureClip = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"StageIn":12,"StageInComplete":30,"ToDetail":47,"ToDetailComplete":63});

	// DollLeft
	this.instance = new lib.GameDollLeft();
	this.instance.setTransform(-483.1,299,1,1,0,0,0,0,-175);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(12).to({alpha:0},0).to({alpha:1},18).wait(56));

	// DollRight
	this.instance_1 = new lib.GameDollRight();
	this.instance_1.setTransform(529,308.1,1,1,0,0,0,0,-170);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(12).to({alpha:0},0).to({alpha:1},18).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.progressDot).wait(48).to({_off:false},0).to({alpha:1},15).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnLeft).wait(48).to({_off:false},0).to({alpha:1},15).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnRight).wait(48).to({_off:false},0).to({alpha:1},15).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.detailContainer).wait(48).to({_off:false},0).to({alpha:1},15).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnBack).wait(48).to({_off:false},0).to({alpha:1},15).wait(23));

	// DotLine
	this.instance_2 = new lib.BlueDotLine();
	this.instance_2.setTransform(0,-26);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({alpha:0},0).to({alpha:1},18).wait(17).to({alpha:0},15).to({_off:true},1).wait(23));

	// L_Label
	this.instance_3 = new lib.L_Label();
	this.instance_3.setTransform(-104.6,176);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({alpha:0},0).to({alpha:1},18).wait(17).to({alpha:0},15).to({_off:true},1).wait(23));

	// R_Label
	this.instance_4 = new lib.R_Label();
	this.instance_4.setTransform(88,177);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({alpha:0},0).to({alpha:1},18).wait(17).to({alpha:0},15).to({_off:true},1).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.leftBike).wait(12).to({alpha:0},0).to({alpha:1},18).wait(17).to({alpha:0},15).to({_off:true},1).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.rightBike).wait(12).to({alpha:0},0).to({alpha:1},18).wait(17).to({alpha:0},15).to({_off:true},1).wait(23));

	// Basement
	this.instance_5 = new lib.product_bg();
	this.instance_5.setTransform(-485,-374);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_6}]},12).to({state:[{t:this.instance_7}]},18).wait(56));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).to({_off:true,alpha:1},18).wait(56));
...
(lib.CardGameClip = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"StageIn":6,"StageInComplete":24,ReadyPlay:62});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(62).call(this.frame_62).wait(80));

	// DollLeft
	this.instance = new lib.GameDollLeft();
	this.instance.setTransform(-469.1,291,1,1,0,0,0,0,-175);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({alpha:0},0).to({alpha:1},18).wait(118));

	// DollRight
	this.instance_1 = new lib.GameDollRight();
	this.instance_1.setTransform(469,276.1,1,1,0,0,0,0,-170);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({alpha:0},0).to({alpha:1},18).wait(118));

	// IntroText
	this.instance_2 = new lib.IntroText();
	this.instance_2.setTransform(-6,20.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({alpha:0},0).to({alpha:1},18).wait(5).to({scaleX:0,scaleY:0},12).to({_off:true},21).wait(80));

	// DotLine
	this.instance_3 = new lib.DotLine();
	this.instance_3.setTransform(-5,-32.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({alpha:0},0).to({alpha:1},18).wait(10).to({scaleX:0,scaleY:0},10).to({_off:true},18).wait(80));

	// Title
	this.instance_4 = new lib.Title();
	this.instance_4.setTransform(15,-140.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({alpha:0},0).to({alpha:1},18).wait(15).to({scaleX:0,scaleY:0},10).to({_off:true},13).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnStart).wait(6).to({alpha:0},0).to({alpha:1},18).wait(20).to({scaleX:0,scaleY:0},11).to({_off:true},7).wait(80));

	// BlueBackground
	this.instance_5 = new lib.BlueBackground();
	this.instance_5.setTransform(-1,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(6).to({alpha:0},0).to({alpha:1},18).wait(25).to({scaleX:0,scaleY:0},12).to({_off:true},1).wait(80));

	// Basement
	this.instance_6 = new lib.Basement();
	this.instance_6.setTransform(9.5,-8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({alpha:0},0).to({alpha:1},18).wait(118));

	// Shadow
	this.instance_7 = new lib.Shadow();
	this.instance_7.setTransform(-22.5,422.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(6).to({alpha:0},0).to({alpha:1},18).wait(118));
...
(lib.IndexClip = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"StageIn":10,"StageInComplete":26});

	// LeftBike
	this.instance = new lib.IndexLeft();
	this.instance.setTransform(-138,164.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({alpha:0},0).to({alpha:1},16).wait(60));

	// RightBike
	this.instance_1 = new lib.IndexRight();
	this.instance_1.setTransform(203,156.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({alpha:0},0).to({alpha:1},16).wait(60));

	// StartButton
	this.startClip = new lib.IndexButtonCombo();
	this.startClip.setTransform(481.5,349.1);

	this.timeline.addTween(cjs.Tween.get(this.startClip).wait(10).to({alpha:0},0).to({alpha:1},16).wait(60));

	// Title
	this.instance_2 = new lib.IndexTitle();
	this.instance_2.setTransform(-8,-346.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({alpha:0},0).to({alpha:1},16).wait(60));
